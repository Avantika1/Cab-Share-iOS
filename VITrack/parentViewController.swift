...
class parentViewController: UIViewController, UIPageViewControllerDataSource {
    ...
    fileprivate let contentImages = ["one",
                                 "two",
                                 "three",
                                 "four"]
    ...
    /* else
     {
     let viewController:UIViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("RevealViewController") as UIViewController
